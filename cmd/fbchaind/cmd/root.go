...
import (
	...
	chainkeys "github.com/fibonacci-chain/core/client/keys"
	serverevm "github.com/fibonacci-chain/core/server"
...
func initRootCmd(
	...
	rootCmd.AddCommand(
		...
		queryCommand(),
		txCommand(),
		chainkeys.Commands(app.DefaultNodeHome),
	)
}
