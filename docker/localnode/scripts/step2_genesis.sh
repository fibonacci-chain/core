...
while read account; do
  echo "Adding: $account"
  fbchaind add-genesis-account "$account" 1000000000000000000000usei
done <build/generated/genesis_accounts.txt

# add funds to admin account
printf "12345678\n" | fbchaind add-genesis-account admin 1000000000000000000000usei
...
fbchaind collect-gentxs >/dev/null 2>&1
