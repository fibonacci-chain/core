...
Detailed instruction: see the `Makefile` in the root of [the repo](https://github.com/fibonacci-chain/core/blob/master/Makefile) 
...
# If you have run docker-cluster-start and build/fbchaind exist, 
...
tail -f build/generated/fbchaind-0.log
```
