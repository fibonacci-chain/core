...
func ParseTxIndexerResult(txResult *tmrpctypes.ResultTx, tx sdk.Tx, getter func(*ParsedTxs) *ParsedTx) (*etherminttypes.TxResult, error) {
	...
	return &etherminttypes.TxResult{
