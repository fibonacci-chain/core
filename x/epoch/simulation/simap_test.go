...
func TestFindAccount(t *testing.T) {
	...
	accs = append(accs, simtypes.Account{
		Address: sdk.AccAddress([]byte("fb1qzdrwc3806zfdl98608nqnsvhg8hn854xs365g")),
	})
	accs = append(accs, simtypes.Account{
		Address: sdk.AccAddress([]byte("fb1jdppe6fnj2q7hjsepty5crxtrryzhuqsjrj95y")),
	})

	// Test with account present
	addr1 := sdk.AccAddress([]byte("fb1qzdrwc3806zfdl98608nqnsvhg8hn854xs365g")).String()
	account, found := epochsimulation.FindAccount(accs, addr1)
	require.True(t, found)
	require.Equal(t, sdk.AccAddress([]byte("fb1qzdrwc3806zfdl98608nqnsvhg8hn854xs365g")), account.Address)
