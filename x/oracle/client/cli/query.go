...
$ fbchaind query oracle exchange-rates

Or, can filter with denom

$ fbchaind query oracle exchange-rates ukrw
`),
...
$ fbchaind query oracle price-snapshot-history
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ fbchaind query oracle feeder terravaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ fbchaind query oracle miss seivaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
