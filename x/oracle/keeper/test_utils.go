...
var (
	...
	InitCoins  = sdk.NewCoins(sdk.NewCoin(utils.MicroFiboDenom, InitTokens))
...
func CreateTestInput(t *testing.T) TestInput {
	...
	totalSupply := sdk.NewCoins(sdk.NewCoin(utils.MicroFiboDenom, InitTokens.MulRaw(int64(len(Addrs)*10))))
	...
	stakingParams.BondDenom = utils.MicroFiboDenom
	...
	bankKeeper.SendCoinsFromModuleToModule(ctx, faucetAccountName, stakingtypes.NotBondedPoolName, sdk.NewCoins(sdk.NewCoin(utils.MicroFiboDenom, InitTokens.MulRaw(int64(len(Addrs))))))
...
func NewTestMsgCreateValidator(address sdk.ValAddress, pubKey cryptotypes.PubKey, amt sdk.Int) *stakingtypes.MsgCreateValidator {
	...
	msg, _ := stakingtypes.NewMsgCreateValidator(
		address, pubKey, sdk.NewCoin(utils.MicroFiboDenom, amt),
