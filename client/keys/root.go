...
import (
	...
	cosmoskeys "github.com/cosmos/cosmos-sdk/client/keys"
)
...
`,
	...
	addCmd := cosmoskeys.AddKeyCommand()
	...
	cmd.AddCommand(
		cosmoskeys.MnemonicKeyCommand(),
		addCmd,
		cosmoskeys.ExportKeyCommand(),
		cosmoskeys.ImportKeyCommand(),
		cosmoskeys.ListKeysCmd(),
		cosmoskeys.ShowKeysCmd(),
		cosmoskeys.DeleteKeyCommand(),
		cosmoskeys.ParseKeyStringCommand(),
