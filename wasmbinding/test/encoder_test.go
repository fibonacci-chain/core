...
const (
	TEST_TARGET_CONTRACT = "fb14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9sh9m79m"
	TEST_CREATOR         = "fb1y3pxq5dp900czh0mkudhjdqjq5m8cpmmps8yjw"
)
...
func TestEncodePlaceOrder(t *testing.T) {
	...
	fund := sdk.NewCoin("ufibo", sdk.NewInt(1000000000))
...
func TestEncodeCreateDenom(t *testing.T) {
	...
	expectedMsg := tokenfactorytypes.MsgCreateDenom{
		Sender:   "fb1y3pxq5dp900czh0mkudhjdqjq5m8cpmmps8yjw",
		Subdenom: "subdenom",
	}
	require.Equal(t, expectedMsg, *typedDecodedMsg)
}
...
func TestEncodeChangeAdmin(t *testing.T) {
	...
	msg := bindings.ChangeAdmin{
		Denom:           "factory/fb1y3pxq5dp900czh0mkudhjdqjq5m8cpmmps8yjw/subdenom",
		NewAdminAddress: "fb1hjfwcza3e3uzeznf3qthhakdr9juetl7g6esl4",
	}
	serializedMsg, _ := json.Marshal(msg)
	...
	expectedMsg := tokenfactorytypes.MsgChangeAdmin{
		Sender:   "fb1y3pxq5dp900czh0mkudhjdqjq5m8cpmmps8yjw",
		Denom:    "factory/fb1y3pxq5dp900czh0mkudhjdqjq5m8cpmmps8yjw/subdenom",
		NewAdmin: "fb1hjfwcza3e3uzeznf3qthhakdr9juetl7g6esl4",
	}
	require.Equal(t, expectedMsg, *typedDecodedMsg)
}
