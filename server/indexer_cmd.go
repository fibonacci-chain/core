...
func NewIndexTxCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			//idxDB, err := OpenIndexerDB(home, GetAppDBBackend(serverCtx.Viper))
			//if err != nil {
			...
			//	}
			//	resBlk, err := stateStore.LoadFinalizeBlockResponses(height)
			//	if err != nil {
			//		return err
			//	}
