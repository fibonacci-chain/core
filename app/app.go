...
import (
	...
	evmkeeper "github.com/fibonacci-chain/core/x/evm/keeper"
	evmtypes "github.com/fibonacci-chain/core/x/evm/types"
	"github.com/fibonacci-chain/core/x/evm/vm/geth"
	...
	"github.com/fibonacci-chain/core/aclmapping"
	...
	mintclient "github.com/fibonacci-chain/core/x/mint/client/cli"
	...
	dexmodule "github.com/fibonacci-chain/core/x/dex"
	dexcache "github.com/fibonacci-chain/core/x/dex/cache"
	dexmodulekeeper "github.com/fibonacci-chain/core/x/dex/keeper"
	dexmoduletypes "github.com/fibonacci-chain/core/x/dex/types"
	dexutils "github.com/fibonacci-chain/core/x/dex/utils"

	oraclemodule "github.com/fibonacci-chain/core/x/oracle"
	oraclekeeper "github.com/fibonacci-chain/core/x/oracle/keeper"
	oracletypes "github.com/fibonacci-chain/core/x/oracle/types"

	epochmodule "github.com/fibonacci-chain/core/x/epoch"
	epochmodulekeeper "github.com/fibonacci-chain/core/x/epoch/keeper"
	epochmoduletypes "github.com/fibonacci-chain/core/x/epoch/types"

	tokenfactorymodule "github.com/fibonacci-chain/core/x/tokenfactory"
...
func New(
	...
	*/
	...
	app.setAnteHandler(&wasmConfig, encodingConfig.TxConfig, cast.ToUint64(appOpts.Get(srvflags.EVMMaxTxGasWanted)))
	...
	if app.LastCommitID().Version > 0 || app.TmConfig == nil || !app.TmConfig.StateSync.Enable {
...
func (app *App) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	metrics.GaugeFiboVersionAndCommit(app.versionInfo.Version, app.versionInfo.GitCommit)
...
func (app *App) setAnteHandler(wasmConfig *wasm.Config, txConfig client.TxConfig, maxGasWanted uint64) {
	...
	ad, err := ante.NewAnteHandler2(ante2.HandlerOptions{
		HandlerOptions: authante.HandlerOptions{
			AccountKeeper:   app.AccountKeeper,
			BankKeeper:      app.BankKeeper,
			FeegrantKeeper:  app.FeeGrantKeeper,
