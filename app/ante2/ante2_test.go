...
// AnteTestSuite2 is a test suite to be used with ante handler tests.
type AnteTestSuite2 struct {
...
func TestKeeperTestSuite(t *testing.T) {
	suite.Run(t, new(AnteTestSuite2))
}

// SetupTest setups a new test, with new app, context, and anteHandler.
func (suite *AnteTestSuite2) SetupTest(isCheckTx bool) {
	suite.Setup()
	...
	antehandler, anteDepGenerator, err := ante2.NewAnteHandlerAndDepGenerator(
...
func (suite *AnteTestSuite2) AnteHandlerValidateAccessOp(acessOps []sdkacltypes.AccessOperation) error {
...
func (suite *AnteTestSuite2) CreateTestTx(privs []cryptotypes.PrivKey, accNums []uint64, accSeqs []uint64, chainID string) (xauthsigning.Tx, error) {
...
func (suite *AnteTestSuite2) TestValidateDepedencies() {
